    ...
    <div className="relative overflow-hidden bg-[#050505] text-white">
      ...
      <section className="relative max-w-4xl mx-auto px-6 pt-12 md:pt-24 pb-16">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/[0.06] bg-[#131316] text-[#6E6E78] font-mono text-[10px] font-medium uppercase tracking-wider mb-6"
        >
        ...
        <motion.p
          ...
          className="text-[#A1A1A9] text-base leading-relaxed max-w-2xl"
        >
      ...
      {/* ── WHY A BROKER ─────────────────────────────────── */}
      <section className="border-t border-white/[0.06] bg-[#0F0F10] py-16 px-6">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="flex items-start gap-4">
            <div className="p-2.5 rounded-xl bg-[#C9A961]/10 border border-[#C9A961]/20 shrink-0 mt-1">
              <Shield className="h-5 w-5 text-[#C9A961]" />
            </div>
            <div className="space-y-3">
              <span className="text-[10px] font-extrabold text-[#C9A961] uppercase tracking-widest font-mono">Why a broker</span>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight leading-snug">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              {
                icon: <Phone className="h-4 w-4 text-[#C9A961]" />,
              ...
              {
                icon: <FileText className="h-4 w-4 text-[#C9A961]" />,
                text: "GST-compliant tax invoice issued for every transaction"
              }
            ].map((item, idx) => (
              <div key={idx} className="flex items-start gap-3 p-4 rounded-xl bg-[#131316] border border-white/[0.06]">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                {[
                  ...
                  <span key={item} className="text-[10px] font-mono font-semibold text-gray-400 bg-[#131316] border border-white/[0.06] px-2.5 py-1 rounded-full">
                    {item}
                  </span>
                ))}
              </div>
      ...
      <section className="border-t border-white/[0.06] bg-[#0F0F10] py-16 px-6">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center space-y-2">
            <span className="text-[10px] font-extrabold text-[#C9A961] uppercase tracking-widest font-mono">Contact</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
            <a
              ...
              className="flex flex-col items-center gap-3 p-5 rounded-2xl bg-[#131316] border border-white/[0.06] hover:border-emerald-500/30 hover:bg-emerald-500/[0.03] transition-all text-center group"
            >
            ...
            <a
              ...
              className="flex flex-col items-center gap-3 p-5 rounded-2xl bg-[#131316] border border-white/[0.06] hover:border-blue-500/30 hover:bg-blue-500/[0.03] transition-all text-center group"
            >
            ...
            <a
              ...
              className="flex flex-col items-center gap-3 p-5 rounded-2xl bg-[#131316] border border-white/[0.06] hover:border-[#C9A961]/30 hover:bg-[#C9A961]/[0.03] transition-all text-center group"
            >
              <div className="p-2.5 rounded-xl bg-[#C9A961]/10 border border-[#C9A961]/20">
                <Phone className="h-5 w-5 text-[#C9A961]" />
              </div>
              <div>
                <p className="text-xs font-bold text-white group-hover:text-[#C9A961] transition-colors">Phone</p>
                <p className="text-[10px] text-gray-500 mt-0.5">+91 93929 74031</p>
              </div>
            </a>
          </div>
